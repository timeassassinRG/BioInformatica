...
#Multi-Authority-Centrality <- GetMultiAuthCentrality(SupraAdjacencyMatrix, Layers, Nodes) #Calculates Multi-Authority-Centrality Avvertimento: sparse->dense coercion: allocating vector of size 7.7 GiBErrore: non è possibile allocare un vettore di dimensione 3.8 Gb
...
```{r}
#alcuni esempi di utilizzo di libreria MuxVizR per analisi del grafo multilayer
```
